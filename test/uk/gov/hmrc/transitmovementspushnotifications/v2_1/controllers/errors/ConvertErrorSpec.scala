...
import uk.gov.hmrc.transitmovementspushnotifications.v2_1.controllers.errors.ErrorCode.InternalServerError
import uk.gov.hmrc.transitmovementspushnotifications.v2_1.controllers.errors.HeaderExtractError.NoHeaderFound
import uk.gov.hmrc.transitmovementspushnotifications.models.common.BoxId
import uk.gov.hmrc.transitmovementspushnotifications.v2_1.services.errors.MongoError._
import uk.gov.hmrc.transitmovementspushnotifications.v2_1.services.errors._
  ...
  "PPNS error" - {
    ...
    "for a failure" in {
      ...
      Seq(
        ...
        PushPullNotificationError.DefaultBoxNotFound               -> StandardError("Default box was not found.", ErrorCode.NotFound),
        PushPullNotificationError.BoxNotFound(BoxId("abc"))        -> StandardError("Box ID abc was not found.", ErrorCode.NotFound)
      ).foreach {
