...
package uk.gov.hmrc.transitmovementspushnotifications.v2_1.repositories
...
import uk.gov.hmrc.transitmovementspushnotifications.v2_1.models._
...
import uk.gov.hmrc.transitmovementspushnotifications.v2_1.models.formats._
...
import uk.gov.hmrc.transitmovementspushnotifications.v2_1.services.errors.MongoError.UnexpectedError
import uk.gov.hmrc.transitmovementspushnotifications.v2_1.services.errors.MongoError.DocumentNotFound
...
class BoxAssociationRepositoryImpl @Inject() (
  ...
  clock: Clock
    ...
    extends PlayMongoRepository[BoxAssociation](
      mongoComponent = mongoComponent,
      collectionName = "box_association_v2_1",
